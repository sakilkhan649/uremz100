    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          ...
          controller.closePip();
          Get.toNamed(Routes.shortsFullSeriesOverlay); // Maintain user's original navigation pattern
        },
        child: Container(
          width: 120.w,
          height: 150.h,
              ...
              children: [
                ...
                Center(
                  child: GestureDetector(
                    ...
                    child: Obx(
                          () => Icon(
                        controller.isPlaying.value ? Icons.pause_circle_filled : Icons.play_arrow,
                        color: Colors.white,
                        size: 40.sp,
                      ),
                    ),
